...
export default function Vehiculo() {
  ...
  const listarCatalogos = useCallback(async () => {
    const [categorias, conductores, configVehiculosSinCombustible] = await Promise.all([
  ...
  const paginarVehiculosConConfig = useCallback(async (page, limit, item) => {
    const [res, configVehiculos] = await Promise.all([
      paginarVehiculo(page, limit, item),
      cargarConfiguracionProgramador(),
    ]);
