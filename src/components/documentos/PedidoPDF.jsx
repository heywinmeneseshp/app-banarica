...
export default function PedidoPDF({ move }) {
    ...
    const styles = StyleSheet.create({
        ...
        movTag: { fontWeight: "bold", width: "30%" },
        ...
        approvedContainer: { display: "flex", flexDirection: "row", justifyContent: "flex-end", textAlign: "left", width: "85%", marginBottom: "30px", marginTop: "20px" },
        left: { width: "30%" },
        right: { width: "70%" },
        ...
        observaciones: { borderTop: "2px solid #AEB6BF", width: "85%", paddingLeft: "5px", paddingRight: "5px", marginBottom: "5px", fontSize: "10" },
            ...
            <Page size="A4"
                ...
                <View style={styles.head}>
                    ...
                    <View style={styles.movimiento}>
                        <View style={styles.movChild}>
                            <Text style={styles.movTag}>Proveedor:</Text>
                            <Text>{move.proveedor}</Text>
                        </View>
                        <View style={styles.movChild}>
                        ...
                        <View style={styles.movChildEnd}>
                            <Text style={styles.movTag}>Pedido:</Text>
                ...
                <View style={styles.table}>
                    <View style={styles.tableHead}>
                        ...
                        <Text style={styles.bulto}>Bultos</Text>
                        <Text style={styles.cantidad}>Cantidad</Text>
                    </View>
                    {move.pedido.map((item, index) => {
                        return (
                            <View key={index} style={styles.tableBody}>
                                <Text style={styles.almacen}>{item.almacen.nombre}</Text>
                                <Text style={styles.cod}>{item.cons_producto}</Text>
                                <Text style={styles.articulo}>{item.producto.name}</Text>
                                <Text style={styles.bulto}>{item.cantidad / item.producto.bulto}</Text>
                ...
                <View style={styles.approvedContainer}>
                    ...
                    <View style={styles.right}>
                        <View style={styles.aprobado}>
                            <Text style={styles.aproTag}>Autorizado por:</Text>
                            <Text style={styles.user}>{move.user.nombre + " " + move.user.apellido}</Text>
                        </View>
                    </View>
                </View>
