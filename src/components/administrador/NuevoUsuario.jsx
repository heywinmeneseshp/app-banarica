                    ...
                    >
                        ...
                        >
                            <div className="modal-body overflow-auto">
                                ...
                                {/* Tab: Datos básicos */}
                                <div style={{ display: activeTab === 'basicos' ? '' : 'none' }}>
                                ...
                                {/* Tab: Permisos */}
                                <div style={{ display: activeTab === 'permisos' ? '' : 'none' }}>
                                    <div className="mt-4 pt-3 border-top">
                                ...
                                {/* Tab: Almacenes */}
                                <div style={{ display: activeTab === 'almacenes' ? '' : 'none' }}>
                                    <div className="mt-4 pt-3 border-top">
                                ...
                                {/* Tab: Transportadoras */}
                                <div style={{ display: activeTab === 'transportadoras' ? '' : 'none' }}>
                                    <div className="mt-4 pt-3 border-top">
                                        <div className="d-flex flex-column flex-lg-row align-items-lg-end justify-content-between gap-3 mb-3">
                                            <div>
